...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  animated fadeInRight blog">
            ...
            <div class="row">
                <c:forEach var="ArticleInfo" items="${MyArticleList.list}">
                    <div class="col-lg-4">
                        <div class="ibox">
            ...
            <div class="box-tools pull-right">
                <ul class="pagination">
                    <li>
                        <a href="${pageContext.request.contextPath}/article/getMyArticle?page=1&size=9&UAccount=<%=user.getUAccount()%>"
                           aria-label="Previous">首页</a></li>
                    <li>
                        <a href="${pageContext.request.contextPath}/article/getMyArticle?page=${MyArticleList.pageNum-1}&size=9&UAccount=<%=user.getUAccount()%>">上一页</a>
                    </li>
                    <c:forEach begin="1" end="${MyArticleList.pages}" var="pageNum">
                        <li>
                            <a href="${pageContext.request.contextPath}/article/getMyArticle?page=${pageNum}&size=9&UAccount=<%=user.getUAccount()%>">${pageNum}</a>
                        </li>
                    </c:forEach>

                    <li>
                        <a href="${pageContext.request.contextPath}/article/getMyArticle?page=${MyArticleList.pageNum+1}&size=9&UAccount=<%=user.getUAccount()%>">下一页</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/article/getMyArticle?page=${MyArticleList.pages}&size=9&UAccount=<%=user.getUAccount()%>"
