                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <form action="${pageContext.request.contextPath}/comment/addComments" method="post">
                                    <div class="col-md-6">
                                ...
                                <form action="${pageContext.request.contextPath}/article/passArticle?AId=${AArticle.AId}"
                                      method="post">
                                    <c:if test="${AArticle.APass=='0'}">
                                        <button class="btn btn-primary btn-xs" type="submit" style="width: 100px ">
                                            通过审核
                                        </button>
                                    </c:if>
